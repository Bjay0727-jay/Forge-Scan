    ...
    schemas: {
      ...
      Vulnerability: {
        ...
        properties: {
          ...
          cwe_ids: { type: 'string', nullable: true, description: 'JSON array of CWE identifiers' },
          affected_products: { type: 'string', nullable: true, description: 'JSON array of affected CPE strings' },
          references_list: { type: 'string', nullable: true, description: 'JSON array of reference URLs' },
